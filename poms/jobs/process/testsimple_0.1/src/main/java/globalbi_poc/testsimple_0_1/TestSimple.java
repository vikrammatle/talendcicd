...
package globalbi_poc.testsimple_0_1;
...
/**
 * Job: TestSimple Purpose: <br>
 * Description:  <br>
 * @author parag.dosi@mail.nissan.co.jp
 * @version 7.2.1.20190909_1035-patch
 * @status 
 */
public class TestSimple implements TalendJob {
	static {System.setProperty("TalendJob.log", "TestSimple.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(TestSimple.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "TestSimple";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_cnk8QBgREeq-rbqiAcclHw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TestSimple.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GLOBALBI_POC_TestSimple = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GLOBALBI_POC_TestSimple.length) {
				if(length < 1024 && commonByteArray_GLOBALBI_POC_TestSimple.length == 0) {
   					commonByteArray_GLOBALBI_POC_TestSimple = new byte[1024];
				} else {
   					commonByteArray_GLOBALBI_POC_TestSimple = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GLOBALBI_POC_TestSimple, 0, length);
			strReturn = new String(commonByteArray_GLOBALBI_POC_TestSimple, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GLOBALBI_POC_TestSimple) {
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/ndh70642/Desktop/out.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/ndh70642/Desktop/out.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public static void main(String[] args){
        final TestSimple TestSimpleClass = new TestSimple();

        int exitCode = TestSimpleClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'TestSimple' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'TestSimple' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = TestSimple.class.getClassLoader().getResourceAsStream("globalbi_poc/testsimple_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TestSimple.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TestSimple");
        }
		if(enableLogStash) {
